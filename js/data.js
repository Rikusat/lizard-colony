...
const CFG = {
  ...
  slitCooldownSec: 10,     // クランク稼働時の作動クールダウン(§9.3-1・左が光り続ける再発防止。実機調整)
  // 失敗球の張り付き(学習性無力感の防止=失敗を"どこまで潜ったかの痕跡"として残す・§C-slit.3-2)
  slitStickSec: 90,        // 張り付いた球が残る秒数(実機調整。長め=記録として溜まる)
  slitStickMax: 14,        // 同時に残せる最大数(超過は外側=浅い/古い順で消し、内側=惜しい記録を優先残置)
