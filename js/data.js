...
const CFG = {
  ...
  // シネマティック オープニング(V5C C1・流儀=案C 切り絵シルエット)。尺・色・挙動はすべてここで調整する。
  //   絵作りの原則: 手前ほど暗く(ほぼ黒)、奥ほど明るい。層は前景/中景/背景の3段以上。層内で色を混ぜない。
  //   パレットは [背景奥, 背景手前, 中景, 前景, 差し色] の5色。前景=ほぼ黒、差し色=琥珀/深紅/緑。
  openingDurSec: [1.8, 1.8, 2.0, 1.8, 1.8, 1.6], // ①崩壊 ②脱出 ③航行 ④実験 ⑤祝祭 ⑥コロニーと題(計10.8s)
  openingSkippable: true,   // クリック/タップ/キーで即中断(確認を挟まない)
  openingAutoPlay: false,   // 初回起動時の自動再生(本編組込はRic判定後に別途指示のため既定OFF)
  openingPal: [
    ["#5a2028", "#3d151c", "#1d0d12", "#07070a", "#c9313a"], // ①崩壊: 深紅の空 → 黒の前景 / 差し色=侵食
    ["#243357", "#182541", "#0d1526", "#06070c", "#f2b23c"], // ②脱出: 夜空 → 黒 / 差し色=科学の琥珀
    ["#1e2c4d", "#152039", "#0b1120", "#05060b", "#e8dcc6"], // ③航行: 星海 / 差し色=白亜
    ["#1a2138", "#111828", "#080c16", "#04050a", "#f2b23c"], // ④実験: 実験室の闇 / 差し色=灯
    ["#2b2540", "#1d1a2e", "#100e1a", "#05050a", "#7bd986"], // ⑤祝祭: 虹の夜 / 差し色=生命の緑
    ["#2f4a3a", "#1f3428", "#122016", "#050806", "#7bd986"], // ⑥コロニー: 緑の地平 / 差し色=生命
  ],
