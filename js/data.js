...
const CFG = {
  ...
  slitRings: 4,             // 円の数(§Q1: 2-3=緊張短い/5-6=高揚長いが各切れ目を広げる必要。4=バランス)
  slitRadiif: [0.92, 0.68, 0.44, 0.2], // 各円の半径(装置半径比・外→内)
  slitHalfDeg: [54, 27, 12.6, 1.8],    // 各円の切れ目の半角(度・外→内で狭まる)。P(通過)=h/180。
                                       // MC実測: 弾かれ ring1:70/ring2:15/ring3:8/ring4:6 / 成功:1%(=1.8/180・滅多に起きない奇跡)
  slitBaseAngleDeg: 90,    // スリットの基準角(度・回廊の向き=真上)。将来は惑星別/緩回転も可
