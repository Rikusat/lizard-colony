...
const CFG = {
  ...
  slitSkinDefault: { rail: [170, 214, 236], glow: [214, 236, 255], center: [226, 168, 192], trace: [205, 232, 246], traceRing: [230, 165, 190], laser: [220, 245, 255], bloom: [255, 215, 190] }, // 現行=青白の星図調
  slitSkinByStage: {
    // 基準カット(2惑星・対照的な組)。他8惑星は既定にフォールバック(展開はRic承認後)。
    2: { rail: [95, 211, 224], glow: [217, 87, 176], center: [217, 87, 176], trace: [140, 214, 232], traceRing: [230, 120, 200], laser: [180, 245, 255], bloom: [220, 100, 190] }, // 摩天楼スラム=ネオン(シアン管/マゼンタ看板・夜の電飾)
    8: { rail: [200, 224, 240], glow: [232, 244, 255], center: [150, 214, 236], trace: [220, 238, 248], traceRing: [176, 214, 232], laser: [240, 250, 255], bloom: [205, 235, 245] }, // 氷の前線=霜白×氷青(冷たい静けさ)
  },
