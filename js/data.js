...
const CFG = {
  ...
  // 失敗球の張り付き(§9.5: ring1で弾かれた球は残さない=1枚以上潜った球のみ記録=残る点すべて「ここまで行けた」証拠)
  slitStickSec: 300,       // 張り付いた球が残る秒数(記録対象が減る分、1つを長く残す=記録性を高める・§9.5)
  slitStickMax: 12,        // 同時に残せる最大数(超過は外側=浅い/古い順で消し、内側=惜しい記録を優先残置)
